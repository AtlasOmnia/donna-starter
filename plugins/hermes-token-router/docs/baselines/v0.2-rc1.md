...
Measured against the local Hermes Agent checkout usinging `agent.model_metadata.estimate_request_tokens_rough` and the live requirement-gated registry.

- Hermes source commit previously inspected: `<commit-hash>`
